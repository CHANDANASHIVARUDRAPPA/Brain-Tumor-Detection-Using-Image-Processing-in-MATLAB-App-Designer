classdef brain < matlab.apps.AppBase
    ...
    if isempty(app.Image2.ImageSource)
        % Display error message if no image is processed
        errordlg('Please apply median filtering first.', 'Error');
        return;
    end
    
    % Convert the RGB image to grayscale
    gray_img = rgb2gray(app.Image2.ImageSource);
...
app.Image4.ImageSource = uint8(highlighted_img);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UploadimageButton.Position = [33 220 100 22];
            app.UploadimageButton.Text = 'Upload image';

            % Create Image
            app.Image = uiimage(app.UIFigure);
            app.Image.Position = [9 264 147 140];
            app.Image.ImageSource = fullfile(pathToMLAPP, 'm5', 'brain1.jpg');

            % Create Image2
            app.Image2 = uiimage(app.UIFigure);
            app.Image2.Position = [173 261 142 142];

            % Create Image3
            app.Image3 = uiimage(app.UIFigure);
            app.Image3.Position = [341 256 151 147];

            % Create Image4
            app.Image4 = uiimage(app.UIFigure);
            app.Image4.Position = [509 254 145 150];
            ...
            app.MedianFilteringButton.Position = [185 220 100 22];
            ...
            app.EdgeDetectionButton.Position = [354 220 100 22];
            ...
            app.TumorDetectionButton.Position = [533 220 103 22];
